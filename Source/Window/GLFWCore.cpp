...
namespace window {
	...
	GLFWCore::createVulkanSurface(vk::Instance instance,
		...
		return glfwCreateWindowSurface(instance,
			...
			allocator ? reinterpret_cast<const VkAllocationCallbacks *>(
					  ...
					  : nullptr,
			reinterpret_cast<VkSurfaceKHR *>(surfaceDestination)) == VK_SUCCESS;
	}
	...
	bool GLFWCore::shouldClose() {
		return glfwWindowShouldClose(m_window);
	}

	void GLFWCore::preLoop() {
		glfwPollEvents();
	}

	void GLFWCore::postLoop() {
		// Nothing yet.
	}
